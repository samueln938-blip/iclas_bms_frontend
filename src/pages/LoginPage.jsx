...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Go back to the page the user wanted, or default to "/"
  ...
  const pageStyle = {
    ...
    padding: "40px 16px",
    // Blue / white branded background with a diagonal feel
    background:
  ...
  const inputStyle = {
    width: "70%", // <== narrower and centered
    maxWidth: "720px",
    height: "46px",
    borderRadius: "999px",
  ...
  const buttonStyle = {
    marginTop: "10px",
    width: "70%", // same width as inputs, centered
    maxWidth: "720px",
    height: "56px",
    borderRadius: "999px",
    border: "none",
